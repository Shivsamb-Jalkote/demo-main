...
```
cd existing_repo
git remote add origin https://gitlab.com/ghandgevikas-group/demo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ghandgevikas-group/demo/-/settings/integrations)
